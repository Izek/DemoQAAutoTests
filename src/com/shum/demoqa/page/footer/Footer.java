...
public class Footer extends AbstractPage {
	...
	@FindBy(xpath = "")
	WebElement twitterLink; // /html/body/div[@id="page"]/footer[@id="colophon"]/div/div/div/aside/ul/li[@class="twitter"]/a/i

	@FindBy(xpath = "")
	WebElement googlePlusLink; // /html/body/div[@id="page"]/footer[@id="colophon"]/div/div/div/aside/ul/li[@class="gplus"]/a/i
